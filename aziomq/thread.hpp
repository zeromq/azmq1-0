...
namespace thread {
     ...
     *      termination message.
     *
     *      Also note, the default signal handling for the background thread is designed to call
     ...
     *  controlled by the returned socket, not a separate zctx_t instance. Also, the notion of
     *  'detached' differs from CZMQ's zthread API. Here a detached thread is simply abandoned
     *  rather than joined at socket destruction.
     */
